...
import com.example.questapi_032.viewmodel.DetailViewModel
import com.example.questapi_032.viewmodel.StatusUIDetail
    ...
    Scaffold(
        ...
        floatingActionButton = {
            ...
            if (uiState is StatusUIDetail.Success) {
                val dataSiswa: DataSiswa = uiState.satusiswa // Kita simpan ke variabel baru
                FloatingActionButton(
                    onClick = {
                        navigateToEditItem(dataSiswa.id) // Cek apakah .id di sini masih merah
                    },
        ...
        navigationIcon = {
            if (canNavigateBack) {
                IconButton(onClick = navigateUp) {
                    Icon(
                        imageVector = Icons.Default.ArrowBack, // Pakai Default agar tidak error
