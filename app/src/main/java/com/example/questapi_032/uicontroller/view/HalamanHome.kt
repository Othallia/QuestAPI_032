...
fun HomeScreen(
    ...
    navigateToItemUpdate: (String) -> Unit, // Saya ubah jadi String biar aman dengan navigasi
    ...
    Column(
        ...
        when (statusUiSiswa) {
            ...
            is StatusUiSiswa.Success ->
                DaftarSiswa(
                    dataSiswa = statusUiSiswa.siswa, // Sesuaikan dengan nama variabel di StatusUiSiswa kamu
...
fun LoadingScreen(modifier: Modifier = Modifier) {
    Image(
        ...
        // Saya sesuaikan dengan nama file gambar yang kita buat sebelumnya (loading_img)
...
fun ErrorScreen(
    ...
    Column(
        ...
        // Saya sesuaikan string resource-nya
        ...
        items(items = dataSiswa, key = { it.id }) { person ->
            ItemSiswa(
                ...
                modifier = Modifier
                    ...
                    .clickable { onSiswaClick(person.id.toString()) } // Konversi ID ke String
            )
        }
    }
}
